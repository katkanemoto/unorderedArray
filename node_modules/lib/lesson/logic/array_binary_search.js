...
array_binary_search.prototype = {
	next: function() {
		...
		if (this._step_state === this._STEP_ALLOCATE_ARROWS) {
			//repositioning text output, after last step
			this._UI.output.self.y += 40;
			
			var output = "Allocating our arrows: 'low' (at the beginning of the array), 'high' (at the end of the array) and 'mid' (at the middle index in the array).";
