...
//TODO: the lesson is allocated inside the UI, this calls the lesson and we have no way to mock it
//	switch over to testing against the real UI
test('[lesson_UI.next] _PRE_LESSON state', {skip: true}, function (t) {
	t.plan(6);
