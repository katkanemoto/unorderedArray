...
lib._.run_tests = function() {
	...
	require('lib/test/lesson/test_unordered_array_linear_search');
	require('lib/test/lesson/test_unordered_array_delete');
	require('lib/test/lesson/test_ordered_array_binary_search');
	require('lib/test/lesson/test_ordered_array_insert');
	require('lib/test/lesson/test_ordered_array_delete');
	
	//lesson logic
	require('lib/test/lesson/logic/test_array_linear_search');
	require('lib/test/lesson/logic/test_array_delete');
	require('lib/test/lesson/logic/test_array_binary_search');
	require('lib/test/lesson/logic/test_array_insert');
	
	//UI
	require('lib/test/UI/test_lesson_UI');
	require('lib/test/UI/test_array_arrow_UI');
	require('lib/test/UI/test_array_UI');
	
	//lesson utilities
	require('lib/test/lesson/util/test_array_lesson_argument_validate');
	require('lib/test/lesson/util/test_pre_lesson_check');
	require('lib/test/lesson/util/test_array_setup');
