...
lib._.run_tests = function() {
	...
	require('lib/test/lesson/test_unordered_array_delete.js');
	require('lib/test/lesson/test_ordered_array_binary_search.js'); */
	
	//lesson logic
	/* require('lib/test/lesson/logic/test_array_linear_search.js');
	...
	//lesson utilities
	/* require('lib/test/lesson/util/test_array_lesson_argument_validate.js');
	require('lib/test/lesson/util/test_pre_lesson_check.js');
