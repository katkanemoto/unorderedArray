var lesson = require('lib/lesson/logic/array_linear_search.js');
...
test('[lesson] incorrect, argument object, UI property right type, array right type, arrow not set', function (t) {
	...
	try {
		...
		t.ok(message.match(/should be type arrow_UI/), "how to fix it");
	}
...
test('[lesson] correct', function (t) {
	...
	var result = lesson({UI:ui, array:array, arrow:arrow});
...
test('[lesson._next] correct, correct state & bad input', function (t) {
	//SETUP
	var ui = SETUP();
	...
	var l = lesson({UI:ui, array:array, arrow:arrow});
	l._state = l._READY;	//setup correct state
	l._next({UI: ui, array:l._array, arrow:l._arrow});
...
test('[lesson._next] correct, STEP 1', function (t) {
	...
	//TEST
	var result = l._next({UI: ui, array:l._array, arrow:l._arrow});
