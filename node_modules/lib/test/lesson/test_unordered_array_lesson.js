...
test('[lesson._setup_array] correct', function (t) {
	...
	t.ok(check.object(result.array), 'made a new array object');
	t.ok(check.object(result.arrow), 'made a new arrow object');
	t.ok(check.not.undefined(result.array.x), 'defined the x');
	t.ok(check.not.undefined(result.array.y), 'and the y');
