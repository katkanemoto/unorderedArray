...
lesson_UI.prototype = {
	...
	next : function() {
		...
		if (this._state === this._LESSON) {
			...
			var proxy_UI = this.get_proxy();
			
			this._lesson = lesson({UI:proxy_UI});
	...
	get_proxy : function() {
		...
		return {
			...
			insert_button : instance._insert_button,
			...
			//an integer indicating at which index the child is stored in the array
			child._.index
			*/
			
			array : {
				working : instance._array,
			},
	...
	_lesson : undefined,		//reference to the lesson logic object, created in the _LESSON state (second call to next())
