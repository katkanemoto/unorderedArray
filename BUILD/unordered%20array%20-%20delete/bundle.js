...
var lesson = require('lib/lesson/unordered_array_delete');
...
},{"lib/UI/lesson_UI":16,"lib/lesson/unordered_array_delete":23,"lib/util/primitives":32}],2:[function(require,module,exports){
...
},{"color-name":3,"simple-swizzle":44}],5:[function(require,module,exports){
module.exports=[
	"xx-small",
	"x-small",
	"small",
...
},{"tcomb":45}],11:[function(require,module,exports){
module.exports=[
	"caption",
	"icon",
	"menu",
...
},{"check-types":2,"lib/UI/array_arrow_UI":15,"lib/util/move":30,"lib/util/primitives":32}],15:[function(require,module,exports){
var check = require('check-types');
var primitives = require("lib/util/primitives");
...
function array_arrow_UI(options) {
	...
	if (check.not.undefined(options.index)) {
		if (check.not.integer(options.index) || (options.index < 0) || (options.array._.length < options.index)) {
...
array_arrow_UI.prototype = {
	...
	_decorate_set : function(arrow, options) {
		...
		arrow._.set = function(index, options) {
			if (check.not.integer(index) || (index < 0) || (array._.length < index)) {
				throw new TypeError("Argument 'index', should be integer and in bounds on the array.");
			}
			...
			arrow._.index = index;
			//if we're at the tail end of the array, then set undefined
			if(index === array._.length) {
			...
			//handle the special case of being set to the 0th position in the array
			if (index === 0) {
				new_x = 22;
			} else {
...
},{"check-types":2,"lib/UI/array_UI":14,"lib/factory/arrow_factory":17,"lib/factory/text_factory":20,"lib/util/move":30,"lib/util/primitives":32}],16:[function(require,module,exports){
	...
	get_proxy : function() {
		...
		return {
			input : {
				...
				disable : function() {instance._text_input._.htmlElement.disabled = true;},
				enable : function() {instance._text_input._.htmlElement.disabled = false;},
			},
			output : {
...
},{"check-types":2,"lib/factory/html_factory":18,"lib/factory/shape_factory":19,"lib/factory/text_factory":20,"lib/util/primitives":32,"pubsub-js":41}],17:[function(require,module,exports){
...
},{"check-types":2,"lib/util/add_to_stage":27,"lib/util/argument_check":29,"lib/util/place":31,"lib/util/primitives":32,"lib/util/type_of":36}],18:[function(require,module,exports){
...
},{"check-types":2,"lib/factory/text_factory":20,"lib/util/add_to_stage":27,"lib/util/append_to":28,"lib/util/argument_check":29,"lib/util/primitives":32,"lib/util/unique_id":37}],19:[function(require,module,exports){
...
},{"check-types":2,"lib/factory/text_factory":20,"lib/util/add_to_stage":27,"lib/util/argument_check":29,"lib/util/place":31,"lib/util/primitives":32,"lib/util/random_color":33}],20:[function(require,module,exports){
...
},{"check-types":2,"lib/util/add_to_stage":27,"lib/util/argument_check":29,"lib/util/primitives":32,"lib/util/random_integer":35}],21:[function(require,module,exports){
var check = require('check-types');
...
array_delete.prototype = {
	...
	next: function() {
		...
		if (this._step_state === this._STEP_1_STATEMENT) {
			var output = "To delete a value from an array...";
...
},{"check-types":2,"lib/lesson/util/array_lesson_argument_validate.js":24}],22:[function(require,module,exports){
var check = require('check-types');
...
function array_linear_search(options) {
	...
	if (!array_arrow_UI.is_arrow(options.arrow)) {
		throw new TypeError("Required argument: arrow, should be type array_arrow_UI.");
	}
	this._arrow = options.arrow;
	
	//require a value to search for in the array supplied
	if(check.not.number(options.value)) {
		throw new TypeError("Required argument: value, should be number.");
	}
...
array_linear_search.prototype = {
	...
	next : function() {
		return this._next({UI: this._UI, array:this._array, arrow:this._arrow, value:this._value});
	},
	...
	_next : function(options) {
		...
		if (this._step_state === this._STEP_1) {
			//reset the "found index" property for this search
			this._found_index = undefined;
			...
			var output = "We'll allocate a find arrow, then" + "\n" +
						...
						"for the value: " + String(value) + ", if we found it" + "\n" + 
		...
		if (this._step_state === this._STEP_SEARCHING_1) {
			...
			"searching for " + "(" + String(value) + ")?";
			
			if (array._.values[current_index] === value) {
				//found case
		...
		if (this._step_state === this._STEP_SEARCHING_2) {
			var current_index = this._find_arrow._.index;
			var output = String(array._.values[current_index]) + " != " + String(value) + ",\n" +
			"so increment the 'find' arrow"  + "\n" +
		...
		if (this._step_state === this._STEP_END_FOUND) {
			...
			"we found the value (" + String(value) + ")" + "\n" +
		...
		if (this._step_state === this._STEP_CLEANUP) {
			...
			return {value:found_index, done:true};
		}
	},
...
},{"check-types":2,"lib/UI/array_UI":14,"lib/UI/array_arrow_UI":15}],23:[function(require,module,exports){
var check = require('check-types')
...
},{"check-types":2,"lib/lesson/logic/array_delete":21,"lib/lesson/logic/array_linear_search":22,"lib/lesson/util/array_setup":25,"lib/lesson/util/pre_lesson_check.js":26,"lib/util/move":30}],24:[function(require,module,exports){
...
},{"check-types":2,"lib/UI/array_UI":14,"lib/UI/array_arrow_UI":15}],25:[function(require,module,exports){
...
},{"check-types":2,"lib/UI/array_UI":14,"lib/factory/text_factory":20,"lib/lesson/util/array_lesson_argument_validate.js":24}],26:[function(require,module,exports){
//get the input from the UI
//	the input is validated and accepts only numbers
//	if the input is NaN, then output an error message and return undefined, to flag the error to the caller
//if the input is valid, then disable the input control and return the sanitized input to the caller
//	so they can continue the lesson, given the input from the user

function pre_lesson_check(UI) {
	var validate = require('lib/lesson/util/array_lesson_argument_validate.js');
...
module.exports = pre_lesson_check;
},{"lib/lesson/util/array_lesson_argument_validate.js":24}],27:[function(require,module,exports){
var primitives = require("lib/util/primitives");
var check = require('check-types');
var type_of = require('lib/util/type_of');
...
},{"check-types":2,"lib/util/primitives":32,"lib/util/type_of":36}],28:[function(require,module,exports){
//duck typing
...
},{"check-types":2}],29:[function(require,module,exports){
...
},{"check-types":2,"color-string":4,"lib/util/type_of":36,"parse-css-font":38}],30:[function(require,module,exports){
	...
	to : function(destination, options) {
		...
		if (_is_moving) {
			...
			createjs.Tween.get(this._source).to({x:destination.x, y:destination.y}, duration).call(function() {
				...
				_is_moving = false;
				_whats_moving = undefined;	//...and clear the reference to what was moving
			});
			return true;
		}
	},
...
move.whats_moving = function() {
	return _whats_moving;
};

module.exports = move;
},{"check-types":2,"lib/util/primitives":32}],31:[function(require,module,exports){
...
},{"check-types":2}],32:[function(require,module,exports){
...
},{"check-types":2,"color-string":4,"lib/util/random_hex":34,"wcag-contrast":95}],34:[function(require,module,exports){
...
},{"check-types":2,"random-js":42}],35:[function(require,module,exports){
...
},{"check-types":2,"random-js":42}],36:[function(require,module,exports){
...
},{"check-types":2,"type-of-is":93}],37:[function(require,module,exports){
var check = require('check-types');
var primitives = require("lib/util/primitives");
...
},{"check-types":2,"lib/util/primitives":32}],38:[function(require,module,exports){
var t = require('tcomb');
...
},{"./lib/helpers":39,"css-font-stretch-keywords":6,"css-font-style-keywords":7,"css-font-weight-keywords":8,"css-global-keywords":9,"css-list-helpers":10,"css-system-font-keywords":11,"tcomb":45,"unquote":94}],39:[function(require,module,exports){
...
},{"css-font-size-keywords":5}],40:[function(require,module,exports){
...
},{"is-arrayish":13}],45:[function(require,module,exports){
/*! @preserve
 *
 * The MIT License (MIT)
 *
...
},{"./lib/Any":46,"./lib/Array":47,"./lib/Boolean":48,"./lib/Date":49,"./lib/Error":50,"./lib/Function":51,"./lib/Nil":52,"./lib/Number":53,"./lib/Object":54,"./lib/RegExp":55,"./lib/String":56,"./lib/assert":57,"./lib/declare":59,"./lib/dict":60,"./lib/enums":61,"./lib/func":64,"./lib/getTypeName":66,"./lib/intersection":67,"./lib/irreducible":68,"./lib/is":69,"./lib/isType":80,"./lib/list":83,"./lib/match":84,"./lib/maybe":85,"./lib/mixin":86,"./lib/refinement":87,"./lib/struct":89,"./lib/tuple":90,"./lib/union":91,"./lib/update":92}],46:[function(require,module,exports){
var irreducible = require('./irreducible');

module.exports = irreducible('Any', function () { return true; });

},{"./irreducible":68}],47:[function(require,module,exports){
var irreducible = require('./irreducible');
var isArray = require('./isArray');

module.exports = irreducible('Array', isArray);

},{"./irreducible":68,"./isArray":70}],48:[function(require,module,exports){
var irreducible = require('./irreducible');
var isBoolean = require('./isBoolean');

module.exports = irreducible('Boolean', isBoolean);

},{"./irreducible":68,"./isBoolean":71}],49:[function(require,module,exports){
var irreducible = require('./irreducible');

module.exports = irreducible('Date', function (x) { return x instanceof Date; });

},{"./irreducible":68}],50:[function(require,module,exports){
var irreducible = require('./irreducible');

module.exports = irreducible('Error', function (x) { return x instanceof Error; });

},{"./irreducible":68}],51:[function(require,module,exports){
var irreducible = require('./irreducible');
var isFunction = require('./isFunction');

module.exports = irreducible('Function', isFunction);

},{"./irreducible":68,"./isFunction":72}],52:[function(require,module,exports){
var irreducible = require('./irreducible');
var isNil = require('./isNil');

module.exports = irreducible('Nil', isNil);

},{"./irreducible":68,"./isNil":75}],53:[function(require,module,exports){
var irreducible = require('./irreducible');
var isNumber = require('./isNumber');

module.exports = irreducible('Number', isNumber);

},{"./irreducible":68,"./isNumber":76}],54:[function(require,module,exports){
var irreducible = require('./irreducible');
var isObject = require('./isObject');

module.exports = irreducible('Object', isObject);

},{"./irreducible":68,"./isObject":77}],55:[function(require,module,exports){
var irreducible = require('./irreducible');

module.exports = irreducible('RegExp', function (x) { return x instanceof RegExp; });

},{"./irreducible":68}],56:[function(require,module,exports){
var irreducible = require('./irreducible');
var isString = require('./isString');

module.exports = irreducible('String', isString);

},{"./irreducible":68,"./isString":78}],57:[function(require,module,exports){
var isFunction = require('./isFunction');
var isNil = require('./isNil');
...
},{"./fail":62,"./isFunction":72,"./isNil":75,"./stringify":88}],58:[function(require,module,exports){
(function (process){
...
},{"./assert":57,"./getFunctionName":65,"./isStruct":79,"./isType":80,"./stringify":88,"_process":40}],59:[function(require,module,exports){
(function (process){
var assert = require('./assert');
...
},{"./assert":57,"./getTypeName":66,"./isNil":75,"./isType":80,"./isTypeName":81,"./mixin":86,"_process":40}],60:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./create":58,"./getTypeName":66,"./is":69,"./isFunction":72,"./isIdentity":73,"./isObject":77,"./isTypeName":81,"_process":40}],61:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
...
},{"./assert":57,"./forbidNewOperator":63,"./isObject":77,"./isString":78,"./isTypeName":81,"_process":40}],62:[function(require,module,exports){
...
},{"./assert":57,"./getTypeName":66}],64:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
...
},{"./Function":51,"./assert":57,"./create":58,"./getFunctionName":65,"./getTypeName":66,"./isArray":70,"./isBoolean":71,"./isNil":75,"./isObject":77,"./isTypeName":81,"./list":83,"./tuple":90,"_process":40}],65:[function(require,module,exports){
...
},{"./getFunctionName":65,"./isType":80}],67:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./getTypeName":66,"./is":69,"./isArray":70,"./isFunction":72,"./isIdentity":73,"./isTypeName":81,"_process":40}],68:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isString = require('./isString');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./forbidNewOperator":63,"./isFunction":72,"./isString":78,"_process":40}],69:[function(require,module,exports){
var isType = require('./isType');
...
},{"./isType":80}],70:[function(require,module,exports){
...
},{"./Boolean":48,"./assert":57,"./getTypeName":66,"./isType":80,"_process":40}],74:[function(require,module,exports){
var isType = require('./isType');

module.exports = function isMaybe(x) {
  return isType(x) && ( x.meta.kind === 'maybe' );
};
},{"./isType":80}],75:[function(require,module,exports){
...
},{"./isArray":70,"./isNil":75}],78:[function(require,module,exports){
...
},{"./isType":80}],80:[function(require,module,exports){
var isFunction = require('./isFunction');
var isObject = require('./isObject');
...
},{"./isFunction":72,"./isObject":77}],81:[function(require,module,exports){
var isNil = require('./isNil');
var isString = require('./isString');
...
},{"./isNil":75,"./isString":78}],82:[function(require,module,exports){
var isType = require('./isType');

module.exports = function isUnion(x) {
  return isType(x) && ( x.meta.kind === 'union' );
};
},{"./isType":80}],83:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./create":58,"./getTypeName":66,"./is":69,"./isArray":70,"./isFunction":72,"./isIdentity":73,"./isTypeName":81,"_process":40}],84:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isFunction = require('./isFunction');
var isType = require('./isType');
...
},{"./Any":46,"./assert":57,"./isFunction":72,"./isType":80,"_process":40}],85:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
var isFunction = require('./isFunction');
...
},{"./Any":46,"./Nil":52,"./assert":57,"./create":58,"./forbidNewOperator":63,"./getTypeName":66,"./is":69,"./isFunction":72,"./isIdentity":73,"./isMaybe":74,"./isTypeName":81,"_process":40}],86:[function(require,module,exports){
(function (process){
var isNil = require('./isNil');
var assert = require('./assert');
...
},{"./assert":57,"./isNil":75,"_process":40}],87:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./create":58,"./forbidNewOperator":63,"./getFunctionName":65,"./getTypeName":66,"./is":69,"./isFunction":72,"./isIdentity":73,"./isTypeName":81,"_process":40}],88:[function(require,module,exports){
...
},{"./Function":51,"./String":56,"./assert":57,"./create":58,"./dict":60,"./getTypeName":66,"./isArray":70,"./isObject":77,"./isStruct":79,"./isTypeName":81,"./mixin":86,"_process":40}],90:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./create":58,"./getTypeName":66,"./is":69,"./isArray":70,"./isFunction":72,"./isIdentity":73,"./isTypeName":81,"_process":40}],91:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isTypeName = require('./isTypeName');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./create":58,"./forbidNewOperator":63,"./getTypeName":66,"./is":69,"./isArray":70,"./isFunction":72,"./isIdentity":73,"./isNil":75,"./isType":80,"./isTypeName":81,"./isUnion":82,"_process":40}],92:[function(require,module,exports){
(function (process){
var assert = require('./assert');
var isObject = require('./isObject');
var isFunction = require('./isFunction');
...
},{"./assert":57,"./isArray":70,"./isFunction":72,"./isNumber":76,"./isObject":77,"./mixin":86,"_process":40}],93:[function(require,module,exports){
(function (factory) {  
...
},{"hex-rgb":12,"relative-luminance":43}]},{},[1]);
