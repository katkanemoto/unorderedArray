...
},{"lib/UI/lesson_UI":16,"lib/lesson/ordered_array_insert":23,"lib/util/primitives":32}],2:[function(require,module,exports){
...
},{"check-types":2,"lib/lesson/util/array_lesson_argument_validate.js":24,"lib/util/move":30}],23:[function(require,module,exports){
var check = require('check-types')
...
function lesson(options) {
	...
	this._array = array_setup({size:6, fill:3, ordered:true, x:50, y:145});
...
lesson.prototype = {
	...
	next : function() {
		...
		if (this._step_state === this._STEP_INIT_SEARCH) {
			...
			var output = "Inserting into an ordered array is a" + "\n" +
				"two step process: first we'll do a" + "\n" +
				"binary search to find the index" + "\n" +
				"where we should insert, then we'll" + "\n" +
				"make room in the array to insert" + "\n" +
				"the value " + String(this._input_tmp) + ".";
		...
		if (this._step_state === this._STEP_SEARCHING) {
			...
			//if we reach the end of the search, then transition to the insertion logic
			if (result.done) {
				var insertion_index = result.value.index;
				var array_insert = require('lib/lesson/logic/array_insert');
				this._insert = array_insert({UI:this._UI, array:this._array, arrow:this._arrow, index:insertion_index, value:this._input_tmp});
				
				this._step_state = this._STEP_INIT_INSERT;
		...
		if (this._step_state === this._STEP_INIT_INSERT) {
			var output = "Now that we've found the index to" + "\n" +
				"insert, we'll make room in the array" + "\n" +
				"to insert " + String(this._input_tmp) + ".";
			
			this._step_state = this._STEP_INSERTING;
		...
		if (this._step_state === this._STEP_INSERTING) {
			var result = this._insert.next();
			
			//if we reach the end of the insert
			if (result.done) {
				if (this._arrow._.index === this._array._.length) {
					//...but if the array is full, then flag DONE, we can't insert into a full array
	...
	_insert :				undefined,	//holds the instance of the insert logic
...
},{"check-types":2,"lib/lesson/logic/array_binary_search":21,"lib/lesson/logic/array_insert":22,"lib/lesson/util/array_setup":25,"lib/lesson/util/pre_lesson_check.js":26,"lib/util/move":30}],24:[function(require,module,exports){
...
},{"check-types":2,"lib/UI/array_UI":14,"lib/factory/text_factory":20,"lib/lesson/util/array_lesson_argument_validate.js":24,"lib/util/random_integer":35}],26:[function(require,module,exports){
